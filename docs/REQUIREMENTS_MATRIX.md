...
| Preserve LGPL/license/attribution | Implemented; verification pending | [LICENSE](../LICENSE), [THIRD_PARTY_NOTICES.md](../THIRD_PARTY_NOTICES.md), preserved history/module paths, and the desktop About panel's upstream/LGPL disclosure | Generate and inspect complete release dependency/license inventory; verify matching source tag and final installer notices |
...
| Requirement | Status | Evidence | Gap / release gate |
|---|---|---|---|
| Current app/frontend tests | Verified at pushed head | [Build and Test run 33253969375](https://github.com/maxtop9843-byte/sendarc/actions/runs/33253969375) passed Go vet, both Go race suites, Svelte check, 77 frontend tests, Wails build, and x86/x64 interceptor matrices at `4d8d1e3` | Repeat for the current metadata commit and immutable release candidate/tag |
| C++/installer CI | Verified at pushed head | x64/x86 Debug/Release jobs passed in [run 33253969375](https://github.com/maxtop9843-byte/sendarc/actions/runs/33253969375); 26-test Pester round-trip passed in [run 33253969365](https://github.com/maxtop9843-byte/sendarc/actions/runs/33253969365) | Repeat for the current metadata commit and immutable release candidate/tag |
...
| Dependency/secret/security audit | Verified locally; CI pending current commit | Both npm audits report 0 vulnerabilities; both Go modules report 0 reachable vulnerabilities; 595-commit Gitleaks history scan is clean; update-integrity and elevated/installer command review are documented in [SECURITY_AUDIT.md](SECURITY_AUDIT.md) | Run staged-content Gitleaks and confirm current-head security/build/installer CI; repeat against the immutable release tag |
