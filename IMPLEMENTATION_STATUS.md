...
- KaPaPi is the parent developer brand while SendArc remains the product name. The public family entry at `https://kapapi.dev/sendarc/` and the full product site at `https://sendarc.pages.dev/` link to each other; the KaPaPi change was merged in [KapapiDev/kapapi-dev.github.io PR #1](https://github.com/KapapiDev/kapapi-dev.github.io/pull/1) as `fb6363d` and passed the post-merge [site-quality run 33627323343](https://github.com/KapapiDev/kapapi-dev.github.io/actions/runs/33627323343) plus live 22-scenario desktop/mobile accessibility checks.
...
- Cloudflare Pages production deployment `97232db3-a627-4517-b174-f4c11b35e686` from `7840d89` is live at `https://sendarc.pages.dev`; all 20 deployed desktop/tablet/mobile/landscape Playwright and axe scenarios pass.
...
- Clean GitHub Actions at commit `7840d89` passed the Wails app and x64/x86 Debug/Release interceptors in [33627281181](https://github.com/KapapiDev/sendarc/actions/runs/33627281181), the 31-case installer Pester round-trip in [33627281163](https://github.com/KapapiDev/sendarc/actions/runs/33627281163), website checks in [33627281195](https://github.com/KapapiDev/sendarc/actions/runs/33627281195), and security/policy checks in [33627281229](https://github.com/KapapiDev/sendarc/actions/runs/33627281229).
