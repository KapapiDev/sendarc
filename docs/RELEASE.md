...
As of 2026-09-01, no SendArc GitHub release has been published. The latest no-publish dry-run is [33499799776](https://github.com/kapapi-dev/sendarc/actions/runs/33499799776) at `4c8fce2`: its exact unsigned installer passed all 31 release acceptance cases, and the downloaded asset independently matched `SHA256SUMS.txt` (`018debc44975d4e4a08b60c3441b754c9bfe4b0c135baa7968267a2320558df6`). Do not turn that dry-run into a launch claim; use [REQUIREMENTS_MATRIX.md](REQUIREMENTS_MATRIX.md) for the remaining real-account and public-release gates.
