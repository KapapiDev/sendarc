...
- Website lint, typecheck, build, link checks, 6 unit tests, and 20 desktop/tablet/mobile/landscape Playwright tests (including axe accessibility) pass locally.
...
- Cloudflare Pages production deployment `5464a9c8-81ea-4e3a-9761-be69f086af63` is live at `https://sendarc.pages.dev`; all 20 deployed desktop/tablet/mobile/landscape Playwright and axe scenarios pass.
...
- Clean GitHub Actions at commit `5e526bc` passed the Wails app and x64/x86 Debug/Release interceptors in [33531293956](https://github.com/KapapiDev/sendarc/actions/runs/33531293956), the 31-case installer Pester round-trip in [33531293901](https://github.com/KapapiDev/sendarc/actions/runs/33531293901), website checks in [33531294046](https://github.com/KapapiDev/sendarc/actions/runs/33531294046), and security/policy checks in [33531293973](https://github.com/KapapiDev/sendarc/actions/runs/33531293973).
...
- Protected installer release dry-run [33532008202](https://github.com/KapapiDev/sendarc/actions/runs/33532008202) built the OAuth-injected Wails app, both interceptor DLLs, unsigned beta installer, and checksum from final repository-address commit `5e526bc` without publishing a tag or release. The exact final installer passed all 31 release Pester cases, including installed x64/x86 ANSI and Unicode system-MAPI routing; neither OAuth value appeared in the workflow log.
- The downloaded dry-run `SendArc-Setup-0.1.0-beta.exe` independently matched `SHA256SUMS.txt` (`7c9a974f4c71a0af1185c9e594856cc34c8529ce6faa8a8fd5cffe3f5ce69a9d`), contained the expected two-file artifact contract, and was confirmed unsigned as authorized.
...
- The final-address Cloudflare deployment was rechecked on 2026-09-02 across desktop, tablet, mobile, small-mobile, and mobile-landscape: all 20 Playwright/axe scenarios passed without creating production form data.
