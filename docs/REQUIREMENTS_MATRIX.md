...
| Requirement | Status | Evidence | Gap / release gate |
|---|---|---|---|
| Current app/frontend tests | Verified at pushed head | [Build and Test run 33283453410](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453410) passed Go vet, both Go race suites, Svelte check, 77 frontend tests, Wails build, Windows app E2E, and x86/x64 Debug/Release interceptor matrices at `d23ca03` | Repeat for the expanded E2E commit and at the immutable release candidate/tag |
| Windows app E2E | Verified locally and in CI | Seven real Wails/WebView2 Playwright scenarios passed locally on 2026-08-30: arrival, local preview, explicit send with complete MIME, Cancel/Dismiss, multi-arrival, Gmail 503 retry, offline queue retention, and repeated-401 re-auth using hermetic local OAuth/Gmail services. The initial five-scenario CI gate passed in [run 33283453410](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453410) | Confirm the expanded seven-scenario suite at the next pushed head and repeat at the immutable release candidate |
| C++/installer CI | Verified at pushed head | x64/x86 Debug/Release jobs passed in [run 33283453410](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453410); 27-test Pester install/uninstall round-trip including version metadata, AUMID, license bundle, coexistence, and previous-handler restoration passed in [run 33283453367](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453367) | Repeat at the immutable release candidate/tag and in final interactive acceptance |
| Website CI/QA | Verified | [Website run 33283453375](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453375) passed at `d23ca03`; 20 live cross-viewport Playwright/axe scenarios also pass on the deployed site | Repeat after the release asset changes download state |
| Dependency/secret/security audit | Verified at pushed head | [Security run 33283453408](https://github.com/maxtop9843-byte/sendarc/actions/runs/33283453408) reproduced the checked-in dependency inventories and passed Gitleaks at `d23ca03`; both npm audits report 0 vulnerabilities, both Go modules report 0 reachable vulnerabilities, and the 595-commit history scan is clean; [SECURITY_AUDIT.md](SECURITY_AUDIT.md) | Repeat against the expanded E2E commit and immutable release tag |
